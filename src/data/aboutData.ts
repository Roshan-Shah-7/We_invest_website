...
export const teamMembers: TeamMember[] = [
    ...
    },
    {
        name: "Ana Magar",
        role: "Market Analyst",
        description: "Head Research Analyst, Anna drives strategic decisions with in-depth market research, identifying high-potential opportunities through data-driven insights.",
        avatarFallback: "AM",
        avatarSrc: "/placeholder.svg?height=96&width=96",
        bgColorFrom: "#00695C",
        bgColorTo: "#00C853",
