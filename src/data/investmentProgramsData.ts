...
export const investmentPrograms: Program[] = [
    {
        ...
        keyFeatures: [
            'Equity Investments: Investments range from Rs.1,00,000 lakh to Rs.1,50,000 lakh million, typically in exchange for a minority equity stake (10-25%).',
            'Strategic Guidance: Access to mentorship, industry networks, and operational expertise to optimize business success.',
            'Focus Areas: Tech sectors, including AI, fintech, and sustainable technology, across We Invest’s regions of operation.',
            'Investment Horizon: 1-2 years, aligned with typical venture capital cycles, with exits via IPOs or acquisitions.',
        ],
        benefits: [
            'Enables startups to scale without immediate repayment pressures.',
    ...
    },
    {
        ...
        keyFeatures: [
            ...
            'Fixed Return: Guaranteed 2% annual return, distributed quarterly, based on the fund’s performance.',
            'Diversified Portfolio: Investments spread across multiple asset classes to mitigate risk.',
            'Flexible Entry: Minimum investment of Rs.1,00,000, suitable for both individual and institutional investors.',
        ],
        benefits: [
    ...
    },
    {
        ...
        keyFeatures: [
            ...
            'Equity Stakes: Investors receive equity in the project or parent company, typically ranging from 5-20%, proportional to the investment size.',
    ...
    },
    {
        ...
        keyFeatures: [
            'Lock-In Periods: Choose from 1-year, 1.5-year, or 2-year terms, with returns varying by duration (4-6% annualized, based on market conditions).',
            ...
            'Minimum Investment: Rs.25,000, with options for reinvestment or withdrawal upon maturity.',
