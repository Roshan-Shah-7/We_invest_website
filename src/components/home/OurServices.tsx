...
const OurServices: React.FC = () => {
    ...
    useLayoutEffect(() => {
        ...
        let ctx = gsap.context(() => {
            ...
            gsap.from(q(".our-services-title"), {
                opacity: 0,
                y: 50,
                duration: 0.8,
                ease: "power3.out",
            ...
            gsap.from(q(".our-services-description"), {
                opacity: 0,
                y: 50,
                duration: 0.8,
                delay: 0.2,
            ...
            gsap.from(q(".service-card"), {
                ...
                scrollTrigger: {
                    trigger: q(".grid"), // Trigger when the grid of cards enters view
                    start: "top 80%",
                    toggleActions: "play none none none",
                },
            });
        ...
        <section ref={sectionRef} className="relative py-20 md:py-28 px-4 sm:px-8 bg-gradient-to-br from-[#f1fff9] to-[#eafffa] border shadow-inner shadow-brand_teal/10 w-full rounded-t-[4rem]">
            <div className="container mx-auto max-w-7xl">
                <div className="text-center mb-16">
                    <h2 className="text-brand_teal text-sm font-semibold tracking-widest uppercase our-services-title">
                        Our Services
                    </h2>
                    <p className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-brand_text_primary leading-tight our-services-title">
                        Empowering Visionaries, Building Futures
                    </p>
                    <p className="mt-6 max-w-2xl mx-auto text-lg text-brand_text_secondary our-services-description">
