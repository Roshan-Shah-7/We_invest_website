            ...
            return (
              <li key={item.id} className="mb-2">
                <button
                  ...
                  className={`flex items-center w-full py-2 px-4 rounded-md text-left transition-colors duration-200 ${
                    activeTab === item.id ? 'bg-brand_green text-white' : 'hover:bg-gray-700 text-gray-300'
                  }`}
                >
