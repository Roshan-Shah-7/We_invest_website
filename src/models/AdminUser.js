...
AdminUserSchema.methods.comparePassword = function (candidatePassword) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt.compare(candidatePassword, this.password)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
};
var AdminUser = mongoose_1.default.models.AdminUser || mongoose_1.default.model('AdminUser', AdminUserSchema);
